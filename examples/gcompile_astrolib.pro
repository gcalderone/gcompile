...
;    Path to the astrolib directory.  If this parameter is not given 
;    the path where this routine is stored will be considered.
;
;USAGE:
;  To compile the 'astrolib' package you should either:
;
;  - copy the gcompile_astrolib.pro file in a directory listed in the
;    IDL_PATH environment variable and call:
;      gcompile_astrolib, 'PATH/TO/astrolib'
;
;  - copy the gcompile_astrolib.pro file in a directory NOT listed in the
;    IDL_PATH environment variable (say PATH/TO/astrolib), add
;    the following line in one of your source files:
;      @PATH/TO/astrolib/gcompile_astrolib.pro
;    and then call:
;      gcompile_astrolib
