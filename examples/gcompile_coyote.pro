...
;    Path to the coyote directory.  If this parameter is not given 
;    the path where this routine is stored will be considered.
;
;USAGE:
;  To compile the 'coyote' package you should either:
;
;  - copy the gcompile_coyote.pro file in a directory listed in the
;    IDL_PATH environment variable and call:
;      gcompile_coyote, 'PATH/TO/coyote'
;
;  - copy the gcompile_coyote.pro file in a directory NOT listed in the
;    IDL_PATH environment variable (say PATH/TO/coyote), add
;    the following line in one of your source files:
;      @PATH/TO/coyote/gcompile_coyote.pro
;    and then call:
;      gcompile_coyote
